...
public class CustomerController {
	...
	public String saveCustomer(
		...
		if (existingCustomerObj != null) {
			existingCustomerObj.setFirstName(theCustomer.getFirstName());
			existingCustomerObj.setLastName(theCustomer.getLastName());
			existingCustomerObj.setEmail(theCustomer.getEmail());
			// save the customer using our service
			customerService.saveCustomer(existingCustomerObj);
		} else {
